...
2)Madhurya.M
######Project Title######
###Cybersecurity Threat Intelligence Graph Using Data Structures###
Team Members
Member 1: KARISHMA SHAIK
Member 2: MADHURYA MUTTUKURI

###Problem Statement###
Cybersecurity systems generate large numbers of threats such as malware, ransomware, and botnets. Managing these threats efficiently requires structured storage, fast search, and relationship analysis. This project builds a threat intelligence platform using graph-based data structures.
###Data Structure Used###
Graph (Adjacency List) → to represent threat relationships
Hash Table → for fast threat lookup
Linked List → to store connected threats
Queue → for BFS traversal
###Algorithm Explanation###
Create threat nodes
Store node IDs in hash table
Connect threats using graph edges
Search threats by type
Traverse graph using BFS
Delete threats when needed
...
Educational cybersecurity models
######5. Literature Review######
...
System flow:
Plain text
User Input → Hash Table Lookup → Graph Storage → BFS Analysis → Output
Modules:
...
📊 PowerPoint Presentation Slides (Simple Order)
Slide 1
Project Title
Slide 2
Problem Statement
...
✅ IEEE formatted PDF content
✅ PPT 10 slides ready content
